            ...
            <div class="contact_register">
                <form action="formulaire2.php" method="post" enctype="multipart/form-data">
                    <div>
                        <div class="name_mail_register">
                            <div class="name_register">
                                ...
                                <input type="text" name="Name" placeholder="John David" required>
                            </div>
                            <div class="mail_register">
                                <p class="titlepayment">commentaire *</p>
                                <input type="text" name="Commentaire" placeholder="votre avis nous interesse" required>
                            </div>
                        </div>
                        <div class="company_subject_register">
                            ...
                            <div class="subject_register">
                                ...
                                <input type="text" name="Profession" placeholder="Comment pouvons nous vous aider" required>
                            </div>
                        </div>
                    </div>
                    <div class="rating">
                    ...
                    <div class="profilpayment">
                        <label class="titlepayment" for="img_profil">Choisissez une photo de profil :</label><br>
                        <input type="file" id="img_profil" name="img_profil" accept="image/*"><br>
                        <label class="titlepayment" for="img_compagny">Choisissez une photo pour votre compagnie :</label><br>
