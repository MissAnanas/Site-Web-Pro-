                    ...
                    <div>
                        <div class="name_mail_register">
                            <div class="name_register">
                                ...
                                <input type="text" name="Name" placeholder="Exemple : John David">
                            </div>
                            <div class="mail_register">
                                <p class="titlepayment">commentaire *</p>
                                <input type="text" name="Commentaire" placeholder="Votre avis nous intéresse!">
                            </div>
                        </div>
                        <div class="company_subject_register">
                            ...
                            <div class="subject_register">
                                ...
                                <input type="text" name="Profession" placeholder="Quel métier exercez-vous?">
                            </div>
                        </div>
                    </div>
                    <div class="rating">
